...
void AT24C02_Write(I2C_TypeDef* I2Cx, unsigned char AddressDevice, unsigned int AddressByte, unsigned char Value)
{
...
//	I2C_AcknowledgeConfig(I2Cx, ENABLE);
	...
	I2C_SendData(I2Cx, (unsigned char)((AddressByte&0xFF00)>>8));
	while(!I2C_CheckEvent(I2Cx, I2C_EVENT_MASTER_BYTE_TRANSMITTED)); // wait send Address Byte
	printf("TEST3\r\n");


	I2C_SendData(I2Cx, (unsigned char)(AddressByte&0xFF));
	while(!I2C_CheckEvent(I2Cx, I2C_EVENT_MASTER_BYTE_TRANSMITTED)); // wait send Address Byte
	printf("TEST4\r\n");
...
unsigned char AT24C02_Read(I2C_TypeDef* I2Cx, unsigned char AddressDevice, unsigned int AddressByte)
{
